...
export default function ClientTracker() {
  ...
  useEffect(()=>{
    async function load(){
      setLoading(true);
      try{
        const[c,p,pif,comp,disp,cms,part,fu,gr]=await Promise.all([
          dbGet("clients"),dbGet("payments"),dbGet("pifClients"),dbGet("completedClients"),
          dbGet("disputeClients"),dbGet("cmsClients"),dbGet("partners"),dbGet("followUps"),dbGet("goalRecord")
        ]);
